...
if os.path.exists('ML-output'): # if ML-output folder path exists 
    shutil.rmtree('ML-output')  # delete ML-output folder
os.makedirs('ML-output')  # make new ML-output folder
